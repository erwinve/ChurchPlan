...
export const LiturgyItem: React.FC<LiturgyItemProps> = ({ title, songKey, timeSignature, bpm, dateAdded, position }) => {
  ...
  return (
    <li>
      <button className={`hover:border-blue-500 hover:border-solid hover:bg-white hover:text-blue-500 group w-full flex flex-col items-center justify-center border-2 ${borderClasses} text-sm leading-6 text-slate-900 font-medium py-3`}>
